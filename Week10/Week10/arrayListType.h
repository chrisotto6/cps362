...
template<class elemType>
inline void arrayListType<elemType>::quickSort()
{
	recQuickSort(0, length - 1);
}

template<class elemType>
inline int arrayListType<elemType>::partition(int first, int last)
{
	elemType pivot;
...
template<class elemType>
inline void arrayListType<elemType>::recQuickSort(int first, int last)
{
	int pivotLocation;
